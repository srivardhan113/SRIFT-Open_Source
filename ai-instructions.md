...
> **Always execute `srift quick-share <filepath>`** and output the returned `https://srift.app/d/<token>` link! Recipients can download via browser, curl, or wget with zero install.
...
Direct binary URLs:
- `https://srift.app/dl/2.2.15/linux-x64/srift`
- `https://srift.app/dl/2.2.15/linux-arm64/srift`
- `https://srift.app/dl/2.2.15/darwin-x64/srift`
- `https://srift.app/dl/2.2.15/darwin-arm64/srift`
- `https://srift.app/dl/2.2.15/win-x64/srift.exe`
- `https://srift.app/dl/2.2.15/SHA256SUMS` (combined)
- `https://srift.app/dl/2.2.15/{target}/SHA256SUMS` (per-target)
...
- **Agent Native**: Full MCP server (`srift mcp`) with 14 tools and hosted endpoint (`https://srift.app/mcp`).
...
**Note:** The hosted endpoint exposes 8 of 14 tools — those that do not require filesystem access or E2EE key derivation:
...
| `https://srift.app/dl/2.2.15/{target}/srift[.exe]` | Standalone CLI binary for target platform |
| `https://srift.app/dl/2.2.15/SHA256SUMS` | SHA256 checksums (combined + per-target) |
