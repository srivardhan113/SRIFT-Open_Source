...
__version__ = "4.1.0"
# Python-urllib's default User-Agent is refused by some CDNs/WAFs (srift.app included).
_UA = f"srift-python-sdk/{__version__}"
...
class Srift:
    ...
    def _call(self, path: str, method: str = "GET", body: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        req = urllib.request.Request(url, data=data, method=method, headers={"Content-Type": "application/json", "User-Agent": _UA})
        try:
    ...
    def stream_events(self):
        ...
        req = urllib.request.Request(f"{self.base_url}/api/v1/monitor/events", headers={"User-Agent": _UA})
